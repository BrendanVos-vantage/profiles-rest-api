...
class UserProfileViewSet(viewsets.ModelViewSet):
    ...
    authentication_classes = (TokenAuthentication,) #, is present to create Tuple in lieu of single variable
    permission_classes = (permissions.UpdateOwnProfile,) # this will ensure all actions are passed through permissions function
    filter_backends = (filters.SearchFilter,)
    search_fields = ('name', 'email',)

class UserLoginApiView(ObtainAuthToken):
    """Handle creating user authentication tokens"""
    renderer_classes = api_settings.DEFAULT_RENDERER_CLASSES # returns renderer classes to auth token view, enabling it on django admin
